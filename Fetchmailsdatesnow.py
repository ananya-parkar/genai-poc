...
for email_id in email_ids:
    ...
    for response_part in msg_data:
        if isinstance(response_part, tuple):
            ...
            resolution_Time = extract_field(body, "Resolution Time")
            ...
            try:
                cur.execute("""
                    INSERT INTO alerts (
                        ...
                        Resolution_Time, Resolved_By, Short_Description, Next_Steps
                    )
                    VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
                """, (
                    number, config_item, incident_subject, business_service,
                    opened, alert_time, state, closed_by, closed, priority,
                    ticket_opened_by, incident_duration, action, resolution_Time,
