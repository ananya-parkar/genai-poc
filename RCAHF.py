...
if __name__ == "__main__":
    ...
    if incidents is not None:
        ...
        # Initialize LLM pipeline for Llama 2 (ensure you have access to this model)
        device = 0 if torch.cuda.is_available() else -1  # Use GPU if available; otherwise CPU
        llm_model = pipeline("text-generation", model="meta-llama/Llama-2-7b-hf", device=device)
